...
pub struct BlockingRetry<B: Backoff, T, E, F: FnMut() -> Result<T, E>, C = (), RF = (), NF = ()> {
    backoff: B,
    retryable: RF,
    notify: NF,
    f: F,
...
impl<B, T, E, F, C, NF> BlockingRetry<B, T, E, F, C, (), NF>
where
    B: Backoff,
    F: FnMut() -> Result<T, E>,
    NF: FnMut(&E, Duration),
...
impl<B, T, E, F, C, RF> BlockingRetry<B, T, E, F, C, RF>
where
    B: Backoff,
    F: FnMut() -> Result<T, E>,
    RF: FnMut(&E) -> bool,
...
impl<B, T, E, F, C, RF, NF> BlockingRetry<B, T, E, F, C, RF, NF>
where
    B: Backoff,
    F: FnMut() -> Result<T, E>,
    RF: FnMut(&E) -> bool,
    ...
    F: FnMut() -> Result<T, E>,
{
    ...
    pub fn context<C>(self, context: C) -> BlockingRetry<B, T, E, F, C, RF, NF> {
        BlockingRetry {
    ...
    F: FnMut() -> Result<T, E>,
{
    ...
    pub fn when_with<RF: FnMut(&E, &C) -> bool>(
        self,
        retryable: RF,
    ) -> BlockingRetry<B, T, E, F, C, RF, NF> {
        BlockingRetry {
    ...
    F: FnMut() -> Result<T, E>,
{
    ...
    pub fn notify_with<NF: FnMut(&E, &C)>(
        self,
        notify: NF,
    ) -> BlockingRetry<B, T, E, F, C, RF, NF> {
        BlockingRetry {
